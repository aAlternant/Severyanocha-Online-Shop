...
function Main(props) {
    const getProcents = (item) => Math.round((item.discount * 100) / item.price);

    return (
        <div className="content">
            <h3 className="">
                {props.searchValue ? `Поиск по запросу "${props.searchValue}"` : 'Акции'}
            </h3>
            <div className="itemBlock d-flex">
                {props.loading
                    ...
                    : props.items
                          ...
                          .map((item) => (
                              <Item
                                  isInCart={props.inCartItems.some(
                                      (obj) => obj.title === item.title,
                                  )}
                                  isInFavorite={props.inFavoriteItems.some(
                                      (obj) => obj.title === item.title,
                                  )}
                                  isFavorite={false}
            ...
            <div className="mapsBlock">
                ...
                <iframe
                    className="mb-15"
                    title="maps"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2180.631029127511!2d41.354497097980534!3d56.86942259883896!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x414d0bae187a68f1%3A0xdbd781d124e7cc59!2z0J_RgNC-0LTRg9C60YLRiyDQnNCw0LPQsNC30LjQvSDQodC10LLQtdGA0Y_QvdC-0YfQutCw!5e0!3m2!1sru!2sbg!4v1651824753329!5m2!1sru!2sbg"
                    width={1200}
                    height={450}
                    style={{ border: 0 }}
                    allowFullScreen=""
